...
clf = RidgeCV(alphas=[1,10,100,1000,10000], cv=900, fit_intercept=False)  # tol = 0.0001

clf.fit(X_total, Y_total, None)
a = clf.coef_

result = pd.DataFrame(a)
result.to_csv("task1b_sara_900fold_different_lambdas.csv", index=False, header=False)
