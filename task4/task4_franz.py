...
# 5. stochastic gradient descent or mlp
...
if __name__ == "__main__":
    ...
    def parameter_selection(set_name, X_train_labeled, y_train_labeled, X_train_unlabeled, X_test, nfold, iid):
        mlp_estimator = [
            ('ss', StandardScaler()),
            ('pca', PCA()),
            ('mlp', MLPClassifier())
    ...
    def re_sampling(data_train_labeled):
        resampled_data_set = []
        X, y = split_into_x_y(data_train_labeled)
        ...
        resampled_data_set.append(("normal", X, y))
        resampled_data_set.append(("adasyn", X_adasyn, y_adasyn))
        resampled_data_set.append(("smote", X_smote, y_smote))
        resampled_data_set.append(("ros", X_ros, y_ros))
        resampled_data_set.append(("nearmiss", X_nearmiss, y_nearmiss))
        resampled_data_set.append(("renn", X_renn, y_renn))
        resampled_data_set.append(("clustercentroids", X_clustercentroids, y_clustercentroids))
        resampled_data_set.append(("smoteenn", X_smoteenn, y_smoteenn))
        resampled_data_set.append(("smotetomek", X_smotetomek, y_smotetomek))

        return resampled_data_set
